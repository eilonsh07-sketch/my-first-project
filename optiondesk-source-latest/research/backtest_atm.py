"""
OptionDesk Backtest ATM Variant — 8 June 2025
==============================================
ATM VARIANT: Strike = spot price (K = S0, OTM_PCT = 0.0)
All other methodology identical to the original 10%-OTM backtest.
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(CACHE_DIR / "backtest_atm_run.log"),
...
def run_backtest(sample_size: int | None = None):
    ...
    out_path = Path("/home/user/workspace/optiondesk/research/backtest_atm_results.json")
    ...
    print("\n" + "="*60)
    print("BACKTEST SUMMARY (ATM VARIANT) — OptionDesk Recommendations 2025-06-08")
    print("="*60)
